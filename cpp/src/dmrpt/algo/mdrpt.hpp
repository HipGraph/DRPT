...
namespace dmrpt {
    ...
    public:
        MDRPT(int ntrees, vector<vector<VALUE_TYPE>> original_data,int tree_depth,int total_data_set_size,int donate_per, dmrpt::StorageFormat storageFormat, int rank, int world_size);
