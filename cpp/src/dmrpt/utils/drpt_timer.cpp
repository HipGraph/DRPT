...
auto dmrpt::Timer<auto>::get_timelapse_in_milliseconds()
{
  return this->timelapse;
}

 auto dmrpt::Timer<auto>::get_timelapse_in_seconds()
{
  return this->timelapse/1000;
}

void dmrpt::Timer<auto>::record_start_time()
{
  this->start_timestamp = high_resolution_clock::now();
}

void dmrpt::Timer<auto>::record_end_time ()
{
