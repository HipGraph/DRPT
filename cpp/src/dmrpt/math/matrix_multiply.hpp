...
namespace dmrpt{
    ...
    public:
        ...
        VALUE_TYPE* distributed_mean(VALUE_TYPE *data,  vector<int> total_elements_per_col, int local_cols, vector<int> total_elements_per_col, dmrpt::StorageFormat format,int rank);
